...
public class InappropriateIntimacyHeuristicSniffer extends SimpleHeuristicSniffer {

	public InappropriateIntimacyHeuristicSniffer() {
		super("InappropriateIntimacy Sniffer", Smell.InappropriateIntimacy());
	}
